...
public final class EmojiconHandler {
	 ...
	 * @param editView
	 */
	public static void removeEmoji(EditText editView) {
		KeyEvent event = new KeyEvent(0, 0, 0, KeyEvent.KEYCODE_DEL, 0, 0, 0, 0, KeyEvent.KEYCODE_ENDCALL);
		editView.dispatchKeyEvent(event);
	}
	 ...
	 * @param emojicon
	 */
	public static void addEmojis(EditText editView, Emojicon emojicon) {
		int start = editView.getSelectionStart();
		int end = editView.getSelectionEnd();
		if (start < 0) {
			editView.append(emojicon.getEmoji());
		} else {
			editView.getText().replace(Math.min(start, end), Math.max(start, end), emojicon.getEmoji(), 0,
	 ...
	 * @param emojiSize
	 */
	public static void replaceEmojis(Context context, Spannable text, int emojiSize) {
